$(function () {
    //表单
    $(".banner .fillInfo").xiaoyingForm({
        parameter: [
            {errorMes:"姓名格式不正确",id:"XY_a01",rename:"姓名"},
            {errorMes:"电话格式不正确",id:"XY_a02",rename:"手机"},
            {errorMes:"微信格式不正确",id:"XY_b11",reg:"required"},
            {errorMes:"请选择日语能力等级",id:"XY_b12",rename:"日语水平",reg:"required"},
            {errorMes:"请选择留学时间",id:"XY_b09",reg:"required"},
            {errorMes:"请填写所在年级",id:"XY_b19",reg:"required"},
            {errorMes:"请选择所在城市",id:"XY_b13",reg:"required"},
        ],
        submitBtn: ".btn input",
    ...
    var hostname = window.location.protocol + '//lang.' + window.location.hostname;
    if (window.location.hostname == 'www.xiao-ying.net')
    {
        hostname = window.location.protocol + '//lang.' + 'xiao-ying.net';
    }else if(window.location.hostname == 'www.xiao-ying.net'){
        hostname = window.location.protocol + '//lang.' + 'xiaoying.net';
    }else if(window.location.hostname == 'www.eggelite.com'){
        hostname = window.location.protocol + '//lang.' + 'eggelite.com';
    }
    console.log(window.location.hostname);

    var hotschool_app = new Vue({
        el: "#schoolLists",
        data: {
            hotsearch: [{
                "name":"YMCA东京日本語学校",
