...
};c.exports=f},{"./data":4,"@marcom/ac-polyfills/Array/prototype.filter":72,"@marcom/ac-polyfills/Array/prototype.some":80}],3:[function(b,c,a){c.exports={getDocumentMode:function(){var d;
...
return}for(g=0;g<j.length;g++){d(h,j[g])}}},{"./className/add":6,"@marcom/ac-polyfills/Array/prototype.slice":79,"@marcom/ac-polyfills/Element/prototype.classList":87}],6:[function(b,c,a){var d=b("./contains");
...
return}for(g=0;g<j.length;g++){b(h,j[g])}}},{"./className/remove":9,"@marcom/ac-polyfills/Array/prototype.slice":79,"@marcom/ac-polyfills/Element/prototype.classList":87}],11:[function(b,c,a){c.exports={EventEmitterMicro:b("./ac-event-emitter-micro/EventEmitterMicro")}
...
}this._events=null};c.exports=f},{}],13:[function(c,d,b){var a=function(){var h="";
...
}},{}],14:[function(b,c,a){c.exports=function d(g){var f;return function(){if(typeof f==="undefined"){f=g.apply(this,arguments)
}return f}}},{}],15:[function(d,b,f){var g=d("./utils/eventTypeAvailable");var j=d("./shared/camelCasedEventTypes");
...
}return o[m]=false}},{"./shared/camelCasedEventTypes":18,"./shared/prefixHelper":20,"./shared/windowFallbackEventTypes":23,"./utils/eventTypeAvailable":24}],16:[function(f,d,h){var a=f("./shared/stylePropertyCache");
...
}return c(p,n[m])}}return c(p,false)}},{"./shared/getStyleTestElement":19,"./shared/prefixHelper":20,"./shared/stylePropertyCache":21,"./utils/toCSS":25,"./utils/toDOM":26}],17:[function(d,b,h){var f=d("./getStyleProperty");
...
}},{"./getStyleProperty":16,"./shared/prefixHelper":20,"./shared/stylePropertyCache":21,"./shared/styleValueAvailable":22}],18:[function(b,c,a){c.exports={transitionend:["webkitTransitionEnd","MSTransitionEnd"],animationstart:["webkitAnimationStart","MSAnimationStart"],animationend:["webkitAnimationEnd","MSAnimationEnd"],animationiteration:["webkitAnimationIteration","MSAnimationIteration"],fullscreenchange:["MSFullscreenChange"],fullscreenerror:["MSFullscreenError"]}
},{}],19:[function(c,d,b){var f;d.exports=function a(){if(!f){f=document.createElement("_")
...
},{}],21:[function(b,c,a){c.exports={}},{}],22:[function(c,b,d){var a=c("./stylePropertyCache");
...
}},{"./getStyleTestElement":19,"./stylePropertyCache":21}],23:[function(b,c,a){c.exports=["transitionend","animationstart","animationend","animationiteration",]
},{}],24:[function(c,f,b){var a={window:window,document:document};f.exports=function d(i,g){var h;
...
}return false}},{}],25:[function(c,d,b){var f=/^(webkit|moz|ms)/gi;d.exports=function a(h){var g;
...
c.exports.original=d},{"./helpers/globals":36,"@marcom/ac-function/once":14}],29:[function(c,f,b){var d=c("@marcom/ac-useragent");
...
}f.exports=g(h);f.exports.original=h},{"./touchAvailable":47,"@marcom/ac-function/once":14,"@marcom/ac-useragent":106}],30:[function(c,d,b){var g=c("./helpers/globals");
...
}}catch(i){}return k}d.exports=f(a);d.exports.original=a},{"./helpers/globals":36,"@marcom/ac-function/once":14}],31:[function(c,d,b){var g=c("@marcom/ac-prefixer/getStyleValue");
...
},{"@marcom/ac-function/once":14,"@marcom/ac-prefixer/getStyleValue":17}],32:[function(c,d,b){var g=c("@marcom/ac-prefixer/getStyleValue");
...
d.exports.original=a},{"@marcom/ac-function/memoize":13,"@marcom/ac-prefixer/getStyleProperty":16,"@marcom/ac-prefixer/getStyleValue":17}],33:[function(b,c,a){var f=b("@marcom/ac-prefixer/getStyleValue");
var d=b("@marcom/ac-function/once");function g(){return !!f("margin","1vw 1vh")
}c.exports=d(g);c.exports.original=g},{"@marcom/ac-function/once":14,"@marcom/ac-prefixer/getStyleValue":17}],34:[function(b,d,a){var f=b("./helpers/globals");
...
},{"./helpers/globals":36,"@marcom/ac-function/memoize":13}],35:[function(c,f,b){var a=c("@marcom/ac-prefixer/getEventType");
var g=c("@marcom/ac-function/memoize");function d(i,h){return !!a(i,h)}f.exports=g(d);
f.exports.original=d},{"@marcom/ac-function/memoize":13,"@marcom/ac-prefixer/getEventType":15}],36:[function(b,c,a){c.exports={getWindow:function(){return window
},getDocument:function(){return document},getNavigator:function(){return navigator
}}},{}],37:[function(d,f,b){var a=d("./touchAvailable").original;var h=d("./helpers/globals");
var g=d("@marcom/ac-function/once");function c(){var i=h.getWindow();return(!a()&&!i.orientation)
}f.exports=g(c);f.exports.original=c},{"./helpers/globals":36,"./touchAvailable":47,"@marcom/ac-function/once":14}],38:[function(f,g,c){var d=f("./isDesktop").original;
var a=f("./isTablet").original;var h=f("@marcom/ac-function/once");function b(){return(!d()&&!a())
}g.exports=h(b);g.exports.original=b},{"./isDesktop":37,"./isTablet":40,"@marcom/ac-function/once":14}],39:[function(b,c,a){var d=b("./helpers/globals");
c.exports=function f(){var g=d.getWindow();return("devicePixelRatio" in g&&g.devicePixelRatio>=1.5)
}},{"./helpers/globals":36}],40:[function(f,g,c){var d=f("./isDesktop").original;
...
}g.exports=h(a);g.exports.original=a},{"./helpers/globals":36,"./isDesktop":37,"@marcom/ac-function/once":14}],41:[function(c,d,a){var g=c("./helpers/globals");
...
}d.exports=f(b);d.exports.original=b},{"./helpers/globals":36,"@marcom/ac-function/once":14}],42:[function(b,c,a){var g=b("./helpers/globals");
var d=b("@marcom/ac-function/once");function f(){var h=g.getWindow();return("HTMLMediaElement" in h)
}c.exports=d(f);c.exports.original=f},{"./helpers/globals":36,"@marcom/ac-function/once":14}],43:[function(c,d,b){c("@marcom/ac-polyfills/matchMedia");
...
},{"./helpers/globals":36,"@marcom/ac-function/once":14,"@marcom/ac-polyfills/matchMedia":104}],44:[function(c,d,b){var g=c("./helpers/globals");
...
d.exports.original=a},{"./helpers/globals":36,"@marcom/ac-function/once":14}],45:[function(c,d,b){var g=c("./helpers/globals");
...
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":36,"@marcom/ac-function/once":14}],46:[function(b,c,a){var g=b("@marcom/ac-prefixer/getStyleValue");
var d=b("@marcom/ac-function/once");function f(){return !!(g("perspective","1px")&&g("transform","translateZ(0)"))
}c.exports=d(f);c.exports.original=f},{"@marcom/ac-function/once":14,"@marcom/ac-prefixer/getStyleValue":17}],47:[function(c,d,b){var g=c("./helpers/globals");
var f=c("@marcom/ac-function/once");function a(){var j=g.getWindow();var h=g.getDocument();
var i=g.getNavigator();return !!(("ontouchstart" in j)||(j.DocumentTouch&&h instanceof j.DocumentTouch)||(i.maxTouchPoints>0)||(i.msMaxTouchPoints>0))
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":36,"@marcom/ac-function/once":14}],48:[function(c,d,b){var g=c("./helpers/globals");
...
}return false}d.exports=f(a);d.exports.original=a},{"./helpers/globals":36,"@marcom/ac-function/once":14}],49:[function(d,f,c){var b=d("@marcom/ac-feature/webGLAvailable");
...
},{"./defaults":50,"@marcom/ac-feature/webGLAvailable":48}],50:[function(b,c,a){c.exports={blacklist:["Intel HD Graphics 5300","AMD Radeon R5 Graphics","Apple A7 GPU"],whitelist:["Radeon FirePro D700","GeForce GT 750 M","Apple A8 GPU","Apple A9 GPU","Apple A9X GPU"]}
},{}],51:[function(g,a,s){var j=a.exports={};var k;var m;function h(){throw new Error("setTimeout has not been defined")
...
};j.umask=function(){return 0}},{}],52:[function(b,d,a){var g=b("@marcom/ac-classlist/add");
...
}}};d.exports=c},{"@marcom/ac-classlist/add":5,"@marcom/ac-classlist/remove":10,"@marcom/ac-object/extend":56}],53:[function(c,b,d){var j="data-focus-method";
...
})}},{"./FeatureDetect":52,"./FocusManager":53,"./defaultTests":55,"@marcom/ac-polyfills":100}],55:[function(f,g,d){var h=f("@marcom/ac-browser");
...
},{"@marcom/ac-browser":1,"@marcom/ac-feature/svgAvailable":45,"@marcom/ac-feature/touchAvailable":47}],56:[function(c,d,b){c("@marcom/ac-polyfills/Array/prototype.forEach");
var a=Object.prototype.hasOwnProperty;d.exports=function f(){var h;var g;if(arguments.length<2){h=[{},arguments[0]]
}else{h=[].slice.call(arguments)}g=h.shift();h.forEach(function(j){if(j!=null){for(var i in j){if(a.call(j,i)){g[i]=j[i]
}}}});return g}},{"@marcom/ac-polyfills/Array/prototype.forEach":73}],57:[function(b,c,a){(function(h){if(!h.console){h.console={}
...
}}})(typeof window==="undefined"?this:window)},{}],58:[function(b,c,a){var d=b("./promise/promise").Promise;
var f=b("./promise/polyfill").polyfill;a.Promise=d;a.polyfill=f},{"./promise/polyfill":62,"./promise/promise":63}],59:[function(c,d,b){var a=c("./utils").isArray;
var g=c("./utils").isFunction;function f(h){var i=this;if(!a(h)){throw new TypeError("You must pass an array to all.")
}return new i(function(o,n){var l=[],m=h.length,q;if(m===0){o([])}function p(r){return function(s){j(r,s)
}}function j(r,s){l[r]=s;if(--m===0){o(l)}}for(var k=0;k<h.length;k++){q=h[k];if(q&&g(q.then)){q.then(p(k),n)
}else{j(k,q)}}})}b.all=f},{"./utils":67}],60:[function(b,c,a){(function(f,g){var o=(typeof window!=="undefined")?window:{};
var l=o.MutationObserver||o.WebKitMutationObserver;var n=(typeof g!=="undefined")?g:(this===undefined?window:this);
function m(){return function(){f.nextTick(p)}}function i(){var s=0;var q=new l(p);
var r=document.createTextNode("");q.observe(r,{characterData:true});return function(){r.data=(s=++s%2)
}}function k(){return function(){n.setTimeout(p,1)}}var j=[];function p(){for(var s=0;
...
},{_process:51}],61:[function(d,f,a){var c={instrument:false};function b(g,h){if(arguments.length===2){c[g]=h
}else{return c[g]}}a.config=c;a.configure=b},{}],62:[function(b,c,a){(function(f){var d=b("./promise").Promise;
var h=b("./utils").isFunction;function g(){var j;if(typeof f!=="undefined"){j=f
}else{if(typeof window!=="undefined"&&window.document){j=window}else{j=self}}var i="Promise" in j&&"resolve" in j.Promise&&"reject" in j.Promise&&"all" in j.Promise&&"race" in j.Promise&&(function(){var k;
new j.Promise(function(l){k=l});return h(k)}());if(!i){j.Promise=d}}a.polyfill=g
}).call(this,typeof global!=="undefined"?global:typeof self!=="undefined"?self:typeof window!=="undefined"?window:{})
},{"./promise":63,"./utils":67}],63:[function(q,d,D){var B=q("./config").config;
...
}D.Promise=h},{"./all":59,"./asap":60,"./config":61,"./race":64,"./reject":65,"./resolve":66,"./utils":67}],64:[function(c,f,b){var a=c("./utils").isArray;
function d(g){var h=this;if(!a(g)){throw new TypeError("You must pass an array to race.")
}return new h(function(m,l){var k=[],n;for(var j=0;j<g.length;j++){n=g[j];if(n&&typeof n.then==="function"){n.then(m,l)
}else{m(n)}}})}b.race=d},{"./utils":67}],65:[function(b,c,a){function d(g){var f=this;
return new f(function(i,h){h(g)})}a.reject=d},{}],66:[function(b,c,a){function d(g){if(g&&typeof g==="object"&&g.constructor===this){return g
}var f=this;return new f(function(h){h(g)})}a.resolve=d},{}],67:[function(d,f,b){function g(i){return h(i)||(typeof i==="object"&&i!==null)
}function h(i){return typeof i==="function"}function a(i){return Object.prototype.toString.call(i)==="[object Array]"
}var c=Date.now||function(){return new Date().getTime()};b.objectOrFunction=g;b.isFunction=h;
b.isArray=a;b.now=c},{}],68:[function(b,c,a){(function(o,q){var k="3.7.3-pre";var h=o.html5||{};
var l=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i;var g=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i;
var v;var m="_html5shiv";var d=0;var s={};var i;(function(){try{var y=q.createElement("a");
y.innerHTML="<xyz></xyz>";v=("hidden" in y);i=y.childNodes.length==1||(function(){(q.createElement)("a");
var A=q.createDocumentFragment();return(typeof A.cloneNode=="undefined"||typeof A.createDocumentFragment=="undefined"||typeof A.createElement=="undefined")
...
o.html5=n;f(q);if(typeof c=="object"&&c.exports){c.exports=n}}(typeof window!=="undefined"?window:this,document))
},{}],69:[function(b,c,a){b("./Array/isArray");b("./Array/prototype.every");b("./Array/prototype.filter");
...
b("./Array/prototype.slice");b("./Array/prototype.some")},{"./Array/isArray":70,"./Array/prototype.every":71,"./Array/prototype.filter":72,"./Array/prototype.forEach":73,"./Array/prototype.indexOf":74,"./Array/prototype.lastIndexOf":75,"./Array/prototype.map":76,"./Array/prototype.reduce":77,"./Array/prototype.reduceRight":78,"./Array/prototype.slice":79,"./Array/prototype.some":80}],70:[function(b,c,a){if(!Array.isArray){Array.isArray=function(d){return Object.prototype.toString.call(d)==="[object Array]"
}}},{}],71:[function(b,c,a){if(!Array.prototype.every){Array.prototype.every=function d(k,j){var h=Object(this);
var f=h.length>>>0;var g;if(typeof k!=="function"){throw new TypeError(k+" is not a function")
}for(g=0;g<f;g+=1){if(g in h&&!k.call(j,h[g],g,h)){return false}}return true}}},{}],72:[function(b,c,a){if(!Array.prototype.filter){Array.prototype.filter=function d(l,k){var j=Object(this);
var f=j.length>>>0;var h;var g=[];if(typeof l!=="function"){throw new TypeError(l+" is not a function")
}for(h=0;h<f;h+=1){if(h in j&&l.call(k,j[h],h,j)){g.push(j[h])}}return g}}},{}],73:[function(b,c,a){if(!Array.prototype.forEach){Array.prototype.forEach=function d(l,k){var j=Object(this);
var f;var g;if(typeof l!=="function"){throw new TypeError("No function object passed to forEach.")
}var h=this.length;for(f=0;f<h;f+=1){g=j[f];l.call(k,g,f,j)}}}},{}],74:[function(b,c,a){if(!Array.prototype.indexOf){Array.prototype.indexOf=function d(g,h){var i=h||0;
var f=0;if(i<0){i=this.length+h-1;if(i<0){throw"Wrapped past beginning of array while looking up a negative start index."
}}for(f=0;f<this.length;f++){if(this[f]===g){return f}}return(-1)}}},{}],75:[function(c,d,b){if(!Array.prototype.lastIndexOf){Array.prototype.lastIndexOf=function a(k,j){var g=Object(this);
var f=g.length>>>0;var h;j=parseInt(j,10);if(f<=0){return -1}h=(typeof j==="number")?Math.min(f-1,j):f-1;
h=h>=0?h:f-Math.abs(h);for(;h>=0;h-=1){if(h in g&&k===g[h]){return h}}return -1
}}},{}],76:[function(b,c,a){if(!Array.prototype.map){Array.prototype.map=function d(l,k){var h=Object(this);
var g=h.length>>>0;var j;var f=new Array(g);if(typeof l!=="function"){throw new TypeError(l+" is not a function")
}for(j=0;j<g;j+=1){if(j in h){f[j]=l.call(k,h[j],j,h)}}return f}}},{}],77:[function(b,c,a){if(!Array.prototype.reduce){Array.prototype.reduce=function d(l,h){var j=Object(this);
var g=j.length>>>0;var k=0;var f;if(typeof l!=="function"){throw new TypeError(l+" is not a function")
}if(typeof h==="undefined"){if(!g){throw new TypeError("Reduce of empty array with no initial value")
}f=j[0];k=1}else{f=h}while(k<g){if(k in j){f=l.call(undefined,f,j[k],k,j);k+=1}}return f
}}},{}],78:[function(c,d,b){if(!Array.prototype.reduceRight){Array.prototype.reduceRight=function a(l,h){var j=Object(this);
var g=j.length>>>0;var k=g-1;var f;if(typeof l!=="function"){throw new TypeError(l+" is not a function")
}if(h===undefined){if(!g){throw new TypeError("Reduce of empty array with no initial value")
}f=j[g-1];k=g-2}else{f=h}while(k>=0){if(k in j){f=l.call(undefined,f,j[k],k,j);
k-=1}}return f}}},{}],79:[function(b,c,a){(function(){var d=Array.prototype.slice;
try{d.call(document.documentElement)}catch(f){Array.prototype.slice=function(n,j){j=(typeof j!=="undefined")?j:this.length;
if(Object.prototype.toString.call(this)==="[object Array]"){return d.call(this,n,j)
}var l,h=[],k,g=this.length;var o=n||0;o=(o>=0)?o:g+o;var m=(j)?j:g;if(j<0){m=g+j
}k=m-o;if(k>0){h=new Array(k);if(this.charAt){for(l=0;l<k;l++){h[l]=this.charAt(o+l)
}}else{for(l=0;l<k;l++){h[l]=this[o+l]}}}return h}}}())},{}],80:[function(b,c,a){if(!Array.prototype.some){Array.prototype.some=function d(k,j){var g=Object(this);
var f=g.length>>>0;var h;if(typeof k!=="function"){throw new TypeError(k+" is not a function")
}for(h=0;h<f;h+=1){if(h in g&&k.call(j,g[h],h,g)===true){return true}}return false
}}},{}],81:[function(b,c,a){if(document.createEvent){try{new window.CustomEvent("click")
}catch(d){window.CustomEvent=(function(){function f(h,i){i=i||{bubbles:false,cancelable:false,detail:undefined};
var g=document.createEvent("CustomEvent");g.initCustomEvent(h,i.bubbles,i.cancelable,i.detail);
return g}f.prototype=window.Event.prototype;return f}())}}},{}],82:[function(b,c,a){b("./Date/now");
b("./Date/prototype.toISOString");b("./Date/prototype.toJSON")},{"./Date/now":83,"./Date/prototype.toISOString":84,"./Date/prototype.toJSON":85}],83:[function(c,d,a){if(!Date.now){Date.now=function b(){return new Date().getTime()
}}},{}],84:[function(b,d,a){if(!Date.prototype.toISOString){Date.prototype.toISOString=function c(){if(!isFinite(this)){throw new RangeError("Date.prototype.toISOString called on non-finite value.")
}var g={year:this.getUTCFullYear(),month:this.getUTCMonth()+1,day:this.getUTCDate(),hours:this.getUTCHours(),minutes:this.getUTCMinutes(),seconds:this.getUTCSeconds(),mseconds:(this.getUTCMilliseconds()/1000).toFixed(3).substr(2,3)};
var h;var f;for(h in g){if(g.hasOwnProperty(h)&&h!=="year"&&h!=="mseconds"){g[h]=String(g[h]).length===1?"0"+String(g[h]):String(g[h])
}}if(g.year<0||g.year>9999){f=g.year<0?"-":"+";g.year=f+String(Math.abs(g.year/1000000)).substr(2,6)
}return g.year+"-"+g.month+"-"+g.day+"T"+g.hours+":"+g.minutes+":"+g.seconds+"."+g.mseconds+"Z"
}}},{}],85:[function(b,c,a){if(!Date.prototype.toJSON){Date.prototype.toJSON=function(h){var i=Object(this);
var d;var g=function(j){var l=typeof j;var k=[null,"undefined","boolean","string","number"].some(function(m){return m===l
});if(k){return true}return false};var f=function(j){var k;if(g(j)){return j}k=(typeof j.valueOf==="function")?j.valueOf():(typeof j.toString==="function")?j.toString():null;
if(k&&g(k)){return k}throw new TypeError(j+" cannot be converted to a primitive")
};d=f(i);if(typeof d==="number"&&!isFinite(d)){return null}if(typeof i.toISOString!=="function"){throw new TypeError("toISOString is not callable")
}return i.toISOString.call(i)}}},{}],86:[function(b,c,a){b("./Element/prototype.classList")
},{"./Element/prototype.classList":87}],87:[function(b,c,a){
/*! @source http://purl.eligrey.com/github/classList.js/blob/master/classList.js*/
if("document" in self){if(!("classList" in document.createElement("_"))){(function(n){if(!("Element" in n)){return
}var d="classList",j="prototype",q=n.Element[j],f=Object,o=String[j].trim||function(){return this.replace(/^\s+|\s+$/g,"")
},g=Array[j].indexOf||function(u){var t=0,s=this.length;for(;t<s;t++){if(t in this&&this[t]===u){return t
...
h.call(this,l)}}};g("add");g("remove")}f.classList.toggle("c3",false);if(f.classList.contains("c3")){var d=DOMTokenList.prototype.toggle;
DOMTokenList.prototype.toggle=function(h,i){if(1 in arguments&&!this.contains(h)===!i){return i
}else{return d.call(this,h)}}}f=null}())}}},{}],88:[function(b,c,a){b("./Function/prototype.bind")
},{"./Function/prototype.bind":89}],89:[function(b,c,a){if(!Function.prototype.bind){Function.prototype.bind=function(d){if(typeof this!=="function"){throw new TypeError("Function.prototype.bind - what is trying to be bound is not callable")
}var i=Array.prototype.slice.call(arguments,1);var h=this;var f=function(){};var g=function(){return h.apply((this instanceof f&&d)?this:d,i.concat(Array.prototype.slice.call(arguments)))
};f.prototype=this.prototype;g.prototype=new f();return g}}},{}],90:[function(require,module,exports){if(typeof JSON!=="object"){JSON={}
}(function(){function f(n){return n<10?"0"+n:n}if(typeof Date.prototype.toJSON!=="function"){Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+f(this.getUTCMonth()+1)+"-"+f(this.getUTCDate())+"T"+f(this.getUTCHours())+":"+f(this.getUTCMinutes())+":"+f(this.getUTCSeconds())+"Z":null
};String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()
}}var cx,escapable,gap,indent,meta,rep;function quote(string){escapable.lastIndex=0;
return escapable.test(string)?'"'+string.replace(escapable,function(a){var c=meta[a];
...
return typeof reviver==="function"?walk({"":j},""):j}throw new SyntaxError("JSON.parse")
}}}())},{}],91:[function(b,c,a){b("./Object/assign");b("./Object/create");b("./Object/is");
b("./Object/keys")},{"./Object/assign":92,"./Object/create":93,"./Object/is":94,"./Object/keys":95}],92:[function(c,d,b){var g=navigator.userAgent.toLowerCase();
...
k<arguments.length;k++){for(var j in arguments[k]){if(arguments[k].hasOwnProperty(j)){arguments[0][j]=arguments[k][j]
}}}return arguments[0]}}}},{}],93:[function(b,c,a){if(!Object.create){var d=function(){};
Object.create=function(f){if(arguments.length>1){throw new Error("Second argument not supported")
}if(f===null||typeof f!=="object"){throw new TypeError("Object prototype may only be an Object.")
}d.prototype=f;return new d()}}},{}],94:[function(b,c,a){if(!Object.is){Object.is=function(f,d){if(f===0&&d===0){return 1/f===1/d
}if(f!==f){return d!==d}return f===d}}},{}],95:[function(b,c,a){if(!Object.keys){Object.keys=function d(g){var f=[];
var h;if((!g)||(typeof g.hasOwnProperty!=="function")){throw"Object.keys called on non-object."
}for(h in g){if(g.hasOwnProperty(h)){f.push(h)}}return f}}},{}],96:[function(b,c,a){c.exports=b("es6-promise").polyfill()
},{"es6-promise":58}],97:[function(b,c,a){b("./String/prototype.trim")},{"./String/prototype.trim":98}],98:[function(c,d,b){if(!String.prototype.trim){String.prototype.trim=function a(){return this.replace(/^\s+|\s+$/g,"")
}}},{}],99:[function(b,c,a){window.XMLHttpRequest=window.XMLHttpRequest||function(){var f;
try{f=new ActiveXObject("Msxml2.XMLHTTP")}catch(d){try{f=new ActiveXObject("Microsoft.XMLHTTP")
}catch(d){f=false}}return f}},{}],100:[function(b,c,a){b("./Array");b("./console.log");
...
b("./String");b("./XMLHttpRequest")},{"./Array":69,"./CustomEvent":81,"./Date":82,"./Element":86,"./Function":88,"./JSON":90,"./Object":91,"./Promise":96,"./String":97,"./XMLHttpRequest":99,"./console.log":101,"./getComputedStyle":102,"./html5shiv":103,"./matchMedia":104,"./requestAnimationFrame":105}],101:[function(b,c,a){b("console-polyfill")
},{"console-polyfill":57}],102:[function(d,f,c){if(!window.getComputedStyle){function g(j,m,l){j.document;
var k=j.currentStyle[m].match(/(-?[\d\.]+)(%|cm|em|in|mm|pc|pt|)/)||[0,0,""],i=k[1],n=k[2],h;
l=!l?l:/%|em/.test(n)&&j.parentElement?g(j.parentElement,"fontSize",null):16;h=m=="fontSize"?l:/width/i.test(m)?j.clientWidth:j.clientHeight;
return n=="%"?i/100*h:n=="cm"?i*0.3937*96:n=="em"?i*l:n=="in"?i*96:n=="mm"?i*0.3937*96/10:n=="pc"?i*12*96/72:n=="pt"?i*96/72:i
}function b(k,n){var o=n=="border"?"Width":"",j=n+"Top"+o,m=n+"Right"+o,h=n+"Bottom"+o,i=n+"Left"+o;
...
}};window.getComputedStyle=function(h){return new a(h)}}},{}],103:[function(b,c,a){b("html5shiv/src/html5shiv")
},{"html5shiv/src/html5shiv":68}],104:[function(b,c,a){window.matchMedia=window.matchMedia||(function(i,j){var g,d=i.documentElement,f=d.firstElementChild||d.firstChild,h=i.createElement("body"),k=i.createElement("div");
k.id="mq-test-1";k.style.cssText="position:absolute;top:-100em";h.style.background="none";
h.appendChild(k);return function(l){k.innerHTML='&shy;<style media="'+l+'"> #mq-test-1 { width:42px; }</style>';
d.insertBefore(h,f);g=k.offsetWidth===42;d.removeChild(h);return{matches:g,media:l}
}}(document))},{}],105:[function(b,c,a){(function(){var f=0;var g=["ms","moz","webkit","o"];
for(var d=0;d<g.length&&!window.requestAnimationFrame;++d){window.requestAnimationFrame=window[g[d]+"RequestAnimationFrame"];
window.cancelAnimationFrame=window[g[d]+"CancelAnimationFrame"]||window[g[d]+"CancelRequestAnimationFrame"]
}if(!window.requestAnimationFrame){window.requestAnimationFrame=function(l,i){var h=Date.now();
var j=Math.max(0,16-(h-f));var k=window.setTimeout(function(){l(h+j)},j);f=h+j;
return k}}if(!window.cancelAnimationFrame){window.cancelAnimationFrame=function(h){clearTimeout(h)
}}}())},{}],106:[function(b,c,a){var d={ua:window.navigator.userAgent,platform:window.navigator.platform,vendor:window.navigator.vendor};
c.exports=b("./parseUserAgent")(d)},{"./parseUserAgent":109}],107:[function(b,c,a){c.exports={browser:{safari:false,chrome:false,firefox:false,ie:false,opera:false,android:false,edge:false,version:{name:"",major:0,minor:0,patch:0,documentMode:false}},os:{osx:false,ios:false,android:false,windows:false,linux:false,fireos:false,chromeos:false,version:{name:"",major:0,minor:0,patch:0}}}
},{}],108:[function(b,c,a){c.exports={browser:[{name:"edge",userAgent:"Edge",version:["rv","Edge"],test:function(d){return(d.ua.indexOf("Edge")>-1||d.ua==="Mozilla/5.0 (Windows NT 10.0; Win64; x64)")
...
},{}],109:[function(b,a,d){var c=b("./defaults");var h=b("./dictionary");function g(k){return new RegExp(k+"[a-zA-Z\\s/:]+([0-9_.]+)","i")
...
return k}a.exports=i},{"./defaults":107,"./dictionary":108}],110:[function(d,b,f){var i=d("@marcom/ac-event-emitter-micro").EventEmitterMicro;
var c=d("@marcom/ac-gpu-reporter/GPUReporter");var a=d("@marcom/ac-useragent");
var h=d("@marcom/ac-feature/isTablet");var j=function(){i.call(this);this._profile=null;
this._reporter=new c();this._gpuClass=this._reporter.getGPUClass({whitelist:["Apple A8X GPU","Apple Software Renderer","AMD Radeon R9 M370X","AMD Radeon R9 M370X OpenGL Engine"]});
this._boundGetProfile=this.getProfile.bind(this)};var g=j.prototype=Object.create(i.prototype);
g.LOW=1;g.MEDIUM=2;g.HIGH=3;g.getGPU=function(){return this.GPU=this.GPU||this._reporter.getGPU()
};g.getProfile=function(){var k=this._getProfile();this._setProfile(k);return k
};g.isGraphics=function(k){return this._getProfile()===this[k]};g._getProfile=function(){var l=this._gpuClass;
var k=["Apple A8 GPU","Apple A9 GPU"];if(l===this._reporter.BLACKLISTED||l===this._reporter.NO_WEBGL){return this.LOW
...
}}if(k.indexOf(this.getGPU())>=0&&!h()){return this.LOW}return this.HIGH};g._getIsIntegratedRetina=function(){return a.browser.safari&&a.os.osx&&this._isRetina()&&window.screen.width<1800
};g._isNonProIPad=function(){return a.os.ios&&h()};g._setProfile=function(k){if(this._profile===k){return
}this._profile=k;this.trigger("change",{profile:k})};g._getMaxAnisotropy=function(){if(typeof this._maxAnisotropy==="number"){return this._maxAnisotropy
}var k=0;try{var l=document.createElement("canvas"),o=l.getContext("webgl")||l.getContext("experimental-webgl");
var m=(o.getExtension("EXT_texture_filter_anisotropic")||o.getExtension("MOZ_EXT_texture_filter_anisotropic")||o.getExtension("WEBKIT_EXT_texture_filter_anisotropic"));
if(m){k=o.getParameter(m.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}}catch(n){}this._maxAnisotropy=k;
return this._maxAnisotropy};g._isRetina=function(){var k=window.devicePixelRatio;
if(!k||k<1.5){return false}return true};b.exports=new j()},{"@marcom/ac-event-emitter-micro":11,"@marcom/ac-feature/isTablet":40,"@marcom/ac-gpu-reporter/GPUReporter":49,"@marcom/ac-useragent":106}],111:[function(d,g,b){var i=d("@marcom/ac-headjs");
var a=d("@marcom/ac-feature");var f=d("@marcom/ac-useragent");var c=d("./model/HeroSupportedModel");
var h=(function(){return{initialize:function(){var k={ie:function(){return f.browser.ie
},edge:function(){return f.browser.edge},firefox:function(){return f.browser.firefox
},safari:function(){return f.browser.safari},handheld:function(){return a.isHandheld()
},"inline-video":function(){return a.isDesktop()},ios8:function(){return f.os.ios&&f.os.version.major===8
},webgl:function(){return a.webGLAvailable()}};var j=c.getClassName();k[j]=c.isSupported;
i.addTests(k);i.htmlClass();return this}}}());g.exports=h.initialize()},{"./model/HeroSupportedModel":112,"@marcom/ac-feature":27,"@marcom/ac-headjs":54,"@marcom/ac-useragent":106}],112:[function(b,d,a){var c=b("../controllers/GraphicsPerformanceController");
var f="hero-animated";d.exports={isSupported:function(){return c.isGraphics("HIGH")
},getClassName:function(){return f}}},{"../controllers/GraphicsPerformanceController":110}]},{},[111]);